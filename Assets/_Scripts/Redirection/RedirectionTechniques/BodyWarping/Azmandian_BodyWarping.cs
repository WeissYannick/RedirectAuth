...
{
    /// <summary>
    ///     Azmandian et al. created a very simple and illustrative example for a body warping scenario, see
    ///     AzmandianExampleScene.unity.
    ...
    ///     More information:
    ///     Mahdi Azmandian et al., Haptic Retargeting: Dynamic Repurposing of Passive Hap-tics for Enhanced Virtual Reality
    ///     Experiences.
    ///     InProceedings of the 2016CHI Conference on Human Factors in Computing Systems (CHI ’16). ACM,New York, NY, USA,
    ///     1968–1979.
    ...
    public class Azmandian_BodyWarping : BodyWarping
    {
        ...
        /// <summary>
        ///     warping ratio. IT quantifies the hand's progression towars the target and determines the amount of warp applied to
        ///     the
        ///     hand's position.
        /// </summary>
        private float a;
            ...
            RedirectionObject target, Transform bodyTransform)
        {
            ...
            w0 = new Vector3(warpOrigin.position.x, 0, warpOrigin.position.z);
            // compute the warping ratio
            Vector3 pH3 = new Vector3(realHandPos.position.x, 0, realHandPos.position.z);
            a = Mathf.Max(0, Mathf.Min(1, Vector3.Dot(wT - w0, pH3 - w0) / Vector3.Dot(wT - w0, wT - w0)));
            ...
            Transform realHandPos, RedirectionObject target)
        {
            ...
            // wT = _realTargetPos;
            wT = new Vector3(_realTargetPos.x, 0, _realTargetPos.z);
            _t = target.GetVirtualTargetPos() - target.GetRealTargetPos();
        }
    }
}